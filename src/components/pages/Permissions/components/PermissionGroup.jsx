...
const SAMPLE_PERMISSION_GROUPS = [
  {
    id: 1,
    name: "Sales Team",
...
const PermissionGroup = () => {
  const [groups, setGroups] = useState(SAMPLE_PERMISSION_GROUPS);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <Text variant="body" color="muted" className="mt-1">
            Manage permission groups for user assignments across all entities
          </Text>
        </div>
