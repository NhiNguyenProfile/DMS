...
// Import same field definitions from SparePartsDetailForm
...
const SparePartsApprovalDetailForm = ({ requestData, onBack }) => {
  ...
  const handleRequestUpdateConfirm = (comment) => {
    console.log(
      "Request update for spare parts:",
      requestData?.id,
      "Comment:",
      comment
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ConfirmationModal
        ...
        message="Request the submitter to update this spare parts request with additional information or corrections."
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to reject this spare parts request? This action will notify the submitter."
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to approve this spare parts request? This will move it to the next step in the workflow."
...
export default SparePartsApprovalDetailForm;
