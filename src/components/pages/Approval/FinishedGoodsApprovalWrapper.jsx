...
const FinishedGoodsApprovalWrapper = ({ onBack }) => {
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <Text variant="body" color="muted">
            Review and approve finished goods requests - single or package operations
          </Text>
        </div>
      </div>
...
export default FinishedGoodsApprovalWrapper;
