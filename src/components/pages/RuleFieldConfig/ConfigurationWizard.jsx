...
const ConfigurationWizard = () => {
  ...
  const steps = [
    ...
    { id: 3, title: "Configuration", description: "Configure fields and rules" },
  ];
    ...
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <Text variant="body" color="muted">
          Choose your country to start configuration
        </Text>
      </div>
  ...
  const renderEntityStep = () => (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <Text variant="body" color="muted">
          Choose the entity type you want to configure
        </Text>
      </div>
            ...
            <div key={step.id} className="flex items-center">
              ...
              <div className="ml-3">
                <Text
                  variant="body"
                  weight="medium"
                  className={currentStep >= step.id ? "text-blue-600" : "text-gray-400"}
                >
                  {step.title}
                </Text>
