...
const DashboardLayout = ({
  ...
  return (
    <div className={layoutClass} {...props}>
      ...
      {/* Main Content Area */}
      <div className="lg:ml-64 flex-1 flex min-h-screen">
        {/* Center Content */}
        <div className="flex-1 flex flex-col">
          ...
          {/* Page Content */}
          <main className="flex-1 p-6 mx-6 border-t border-x shadow-sm rounded-t-2xl overflow-y-auto overflow-x-hidden bg-white">
            {children}
          </main>
        </div>
      </div>
